...
def convert(obj, rtype, target_ver, downgrade_ver=None, actual_resource_version=None):
    # Ensure an API version is set on the object
    current_version = 'v1.0'
    if actual_resource_version:
        current_version = actual_resource_version
    elif "@_apiversion" in obj:
        current_version = obj["@_apiversion"]
    ...
    if _api_ver_compare(target_ver, "v1.3") < 0 and current_version == "v1.3":
        obj = _v1_3_to_v1_2(obj, rtype)
        current_version = "v1.2"
    if _api_ver_compare(target_ver, "v1.2") < 0 and current_version == "v1.2":
        obj = _v1_2_to_v1_1(obj, rtype)
        current_version = "v1.1"
    if _api_ver_compare(target_ver, "v1.1") < 0 and current_version == "v1.1":
    ...
    if target_ver == current_version:
        return obj
    elif downgrade_ver and _api_ver_compare(current_version, downgrade_ver) >= 0:
        return obj
