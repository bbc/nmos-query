...
# Currently these have hard-coded dummy/example hostnames, IP addresses and UUIDs.
           ...
           u'nodes': [{u'createdIndex': 6068,
                       ...
                       u'nodes': [{u'createdIndex': 6074,
                                  ...
                                  {u'createdIndex': 6076,
                                   ...
                                   u'value': u'{"href": "http://127.0.0.1:1234/path",  "id": "90461aaa-a45a-48f0-ba2e-de51b45ce4ce", "label": "test_node", "services": [{"type": "urn:x-ipstudio:service:mdnsbridge/v1.0"}]}'},
                                  {u'createdIndex': 6077,
                                   u'key': u'/resource/nodes/007ff4e5-fe72-4c4b-b858-4c5f37dff946',
                                   u'modifiedIndex': 6077,
                                   u'value': u'{"href": "http://192.168.100.100:12345/", "id": "007ff4e5-fe72-4c4b-b858-4c5f37dff946", "label": "hostname.example.com", "services": [{"type": "urn:x-ipstudio:service:pipelinemanager/v1.0"}]}'}]}]}}
...
class TestQuery(unittest.TestCase):
    ...
    def test_parse_services_dict_all(self):
        expected = [
            ...
            {u"href": "http://192.168.100.100:12345/",
             u"id": u"007ff4e5-fe72-4c4b-b858-4c5f37dff946", u"label": u"hostname.example.com", "services": [{"type": "urn:x-ipstudio:service:pipelinemanager/v1.0"}]},
            {u"href": u"http://127.0.0.1:1234/path",
             u"id": u"90461aaa-a45a-48f0-ba2e-de51b45ce4ce", u"label": u"test_node", "services": [{"type": "urn:x-ipstudio:service:mdnsbridge/v1.0"}]}
        ]
    ...
    def test_parse_services_dict_with_array_args_one_result(self):
        args = {'services.type': 'urn:x-ipstudio:service:pipelinemanager/v1.0'}
        expected = [{u"href": "http://192.168.100.100:12345/",
                     u"id": u"007ff4e5-fe72-4c4b-b858-4c5f37dff946", u"label": u"hostname.example.com", "services": [{"type": "urn:x-ipstudio:service:pipelinemanager/v1.0"}]}]
        actual = self.query.parse_services_dict(NODES_RESPONSE, "nodes/", args, verbose=True)
        six.assertCountEqual(self, expected, actual)
