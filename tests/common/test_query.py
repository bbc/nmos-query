...
flow_data_versions = { v : remove_at_keys(downgrade_api_version(copy.deepcopy(flow_data), "flows", v)) for v in API_VERSIONS }
flow_v1_0_data_versions = { v : remove_at_keys(downgrade_api_version(copy.deepcopy(flow_v1_0_data), "flows", v, "v1.0")) for v in API_VERSIONS }
sender_data_versions = { v : remove_at_keys(downgrade_api_version(copy.deepcopy(sender_data), "senders", v)) for v in API_VERSIONS }
